...
Create a system to remember user data and authenticate that user and protect aspects of a website or app

What steps can you take in your web apps to keep your data secure?

Creating an authentication system such as logging in and protective routes.

Describe how web servers work.

Web servers are computers that have programs, either directly on the computer they're working on or remotely, to host and store and process data and code for websites and applications.
